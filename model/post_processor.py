...
class CondLanePostProcessor(object):
    ...
    def __init__(self, mask_size, hm_thr=0.5, min_points=5, hm_downscale=16, mask_downscale=8, use_offset=True, **kwargs):
        self.hm_thr = hm_thr
        ...
        self.pos = self.compute_locations(mask_size, device="cuda").repeat(100, 1, 1)
